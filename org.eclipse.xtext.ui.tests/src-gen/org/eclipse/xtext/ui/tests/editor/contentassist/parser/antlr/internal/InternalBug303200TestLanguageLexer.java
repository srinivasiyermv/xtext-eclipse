...
public class InternalBug303200TestLanguageLexer extends Lexer {
    ...
    public final void mT__7() throws RecognitionException {
        try {
            ...
            // InternalBug303200TestLanguage.g:11:6: ( 'function' )
            // InternalBug303200TestLanguage.g:11:8: 'function'
            {
            match("function"); 
    ...
    public final void mT__8() throws RecognitionException {
        try {
            int _type = T__8;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug303200TestLanguage.g:12:6: ( '[' )
            // InternalBug303200TestLanguage.g:12:8: '['
            {
            match('['); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug303200TestLanguage.g:982:9: ( ( 'a' .. 'z' | 'A' .. 'Z' )+ )
            // InternalBug303200TestLanguage.g:982:11: ( 'a' .. 'z' | 'A' .. 'Z' )+
            {
            // InternalBug303200TestLanguage.g:982:11: ( 'a' .. 'z' | 'A' .. 'Z' )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug303200TestLanguage.g:984:9: ( ( ' ' | '\\t' )+ )
            // InternalBug303200TestLanguage.g:984:11: ( ' ' | '\\t' )+
            {
            // InternalBug303200TestLanguage.g:984:11: ( ' ' | '\\t' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_LT() throws RecognitionException {
        try {
            int _type = RULE_LT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug303200TestLanguage.g:986:9: ( ( '\\r' | '\\n' ) )
            // InternalBug303200TestLanguage.g:986:11: ( '\\r' | '\\n' )
            {
            if ( input.LA(1)=='\n'||input.LA(1)=='\r' ) {
                input.consume();
